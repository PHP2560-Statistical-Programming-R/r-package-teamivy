...
funct.team.sched <- function(team) {
  ...
  urltable <- paste0("https://widgets.sports-reference.com/wg.fcgi?css=1&site=bbr&url=%2Fteams%2F",
                     team, "%2F", "2018", ".html&div=div_advanced")
  ...
  names(schedule.team)[2] <- "Time"
  names(schedule.team)[3] <- "Home"
  names(schedule.team)[5] <- "Result"
  names(schedule.team)[6] <- "TeamPoints"
  names(schedule.team)[7] <- "OppPoints"
